...
const topColors = ["#965f8f", "#c398b9", "#e4bbd9"]
const otherColor = "#f2f5f7";
...
export default class Leaderboard extends Component {
  ...
  static propTypes = {
    ...
    currentRowColor:PropTypes.string
  };
  ...
  defaultRenderItem = (item, index) => {
    ...
    const topColor = index === 0 ? topColors[0] : 
    (index === 1) ? topColors[1] :
    (index === 2) ? topColors[2] : otherColor
