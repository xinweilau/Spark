...
export default function ActivityItem(props: Activity) {
    ...
    return (
        <View style={tw`flex flex-col gap-8 rounded-3xl bg-[#F0F0FF] min-w-7/8 p-5 justify-between shadow-sm`}>
            <View style={tw`flex flex-col gap-2`}>
                <View style={tw`flex flex-row flex-nowarp items-center justify-between`}>
